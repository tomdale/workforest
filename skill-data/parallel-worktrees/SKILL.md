...
description: Workforest guidance for using task worktrees with parallel AI subagents. Use when delegating independent tasks, creating short-lived worktrees with `wf task create`, handing paths to subagents, reviewing and merging subagent branches, listing tasks, or cleaning them up safely.
---
