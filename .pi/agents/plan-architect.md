---
name: plan-architect
description: Read-only broad planner for large Workforest refactors and new implementations. Use to produce end-state design, sequencing, and checkpoint boundaries.
