...
describe("shell integration", () => {
  ...
  it("renders generated bash completion for both executable names", () => {
    ...
    expect(script).toContain(
      "_workforest_complete_words 'new clean list status workspace task worktree cache review template shell config skills help version'",
    );
    expect(script).toContain(
  ...
  it("derives completion and handoff commands from the registry", () => {
    ...
    expect(script).toContain(
      "_workforest_complete_words 'new clean inspect visit list status workspace",
    );
    expect(script).toContain(
